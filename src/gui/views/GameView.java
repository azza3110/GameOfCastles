...
public class GameView extends View implements GameInterface {
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        if(actionEvent.getSource() == button) {
            ...
            switch (button.getText()) {
            	case "JOKER":
            		game.jokerToUse();
            		game.getCurrentPlayer().getJoker();
            	case "Nächste Runde":
	...
	@Override
	public void onDefenderLost(Player defender) {
		if(defender.hasJoker()) {
		button.setText("JOKER");
		logLine(defender.getName() + " lost this fight and can Use the Joker to Stop the fight");}
	}

	@Override
	public void onAttackerLost(Player attacker) {
		if(attacker.hasJoker())
			button.setText("JOKER");
		logLine(attacker.getName() + " lost this fight and can Use the Joker to Stop the fight");
	}
}
