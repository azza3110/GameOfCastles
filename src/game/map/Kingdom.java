...
public class Kingdom {
    ...
    public void removeCastles() {
        this.castles.removeAll(castles);
    }
    ...
    public boolean isEmpty() {
    	return (castles.stream().filter(c -> c.getOwner() != null).collect(Collectors.toList()).isEmpty() && !castles.isEmpty());
    	
    }

	public boolean isFull() {
		return castles.stream().filter(c -> c.getOwner() == null).collect(Collectors.toList()).isEmpty();
	}
